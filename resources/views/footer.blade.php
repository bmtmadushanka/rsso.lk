                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4>About Us</h4>
                            <ul>
                                <li><i class="ion-ios-arrow-forward"></i> <a href="{{route('index')}}">Home</a></li>
                                <li><i class="ion-ios-arrow-forward"></i> <a href="{{route('about')}}">About us</a></li>
                                <li><i class="ion-ios-arrow-forward"></i> <a href="{{route('services')}}">Our services</a></li>
